...
#else
#error To use applibs/spi.h you must first #define SPI_STRUCTS_VERSION
#endif
...
///     <para>The interface is initialized with the default settings: SPI_Mode_0, SPI_BitOrder_MsbFirst.
///     You can change these settings with SPI functions after the interface is opened.</para>
///     <para>The config paramter points to another group of settings that you can't change after
///     <see cref="SPIMaster_Open"/> is called. Before you call <see cref="SPIMaster_Open"/>, you must call
///     <see cref="SPIMaster_InitConfig"/> to initialize the <see cref="SPIMaster_Config"/> struct
///     for the config paramter. After you initialize the struct, you can change the configuration
///     until <see cref="SPIMaster_Open"/> is called.</para>
///     <para> **Errors** </para>
...
///     manifest.</para>
///     <para>ENOENT: the specified IDs are invalid.</para>
///     <para>Any other errno may also be specified, such errors aren't deterministic and there's
///     no guarantee that the same behavior will be retained through system updates.
/// </summary>
...
///     Before you call this function, you must call <see cref="SPIMaster_InitConfig"/> to initialize
///     this <see cref="SPIMaster_Config"/> struct. After you initialize the struct, any changes you
///     make to the configuration must be made before <see cref="SPIMaster_Open"/> is called.
/// </param>
/// <returns>
...
/// <summary>
///     Initializes an array of <see cref="SPIMaster_Config"/> structs with the default SPI master
///     transfer settings.
/// </summary>
...
/// </param>
/// <param name="transferCount">
///     The number of <see cref="SPIMaster_Transfer"/> structures in the <paramref name="transfers"/>
///     array.
/// </param>
/// <returns>
///     The number of bytes transferred; or -1 for failure, in which case errno is set to the error
