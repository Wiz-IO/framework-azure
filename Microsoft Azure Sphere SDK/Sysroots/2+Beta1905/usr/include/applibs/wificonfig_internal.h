...
///     WifiConfig_StoredNetwork structs that are type cast as z__WifiConfig_StoredNetwork_Base structs.
/// </param>
...
///     <para>If scannedNetworkArray is too small to hold all the networks, this function fills the array
///     returns the number of array elements.</para>
///     <para> **Errors** </para>
///     If an error is encountered, returns -1 and sets errno to the error value.
///     <para>EACCES: the application manifest does not include the WifiConfig capability.</para>
...
/// </param>
/// <returns>
///     The number of elements in the WifiConfig_ScannedNetwork array, or -1 for failure, in which case 
