...
/// </param>
/// <param name="uartConfig">
///     A pointer to an object that contains the UART settings. The object is a <see cref="UART_Config"/>
///     that is type cast as <see cref="z__UART_Config_Base"/>.
/// </param>
/// <returns>
...
/// </param>
/// <param name="uartConfig">
///     A pointer to a <see cref name="UART_Config"/> object that contains the UART settings.
