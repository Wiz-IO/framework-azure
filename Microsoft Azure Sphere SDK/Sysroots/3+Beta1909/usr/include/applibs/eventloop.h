...
/// <param name="events"> Bitmask of the events to monitor </param>
/// <param name="callback"> Pointer to the callback function to call when any of the events fire.
/// </param>
/// <returns>
...
///     cref="EventLoop_UnregisterIo"/> with the pointer or closes the object with <see
...
///     same EventLoop object. Trying to unregister a EventRegistration with a different EventLoop
