 ...
 *	}
 *
 *	static int _mtk_os_hal_pwm_config_gpio(int group_num,
 *		u32 channel_bit_map)
 *	{
 *		int ret = 0;
 *
 ...
 *						OS_HAL_GPIO_0);
 *				ret |= mtk_os_hal_gpio_pmx_set_mode(
 *							OS_HAL_GPIO_0,
 *							OS_HAL_MODE_1);
 *				ret |= mtk_os_hal_gpio_set_direction(
 *							OS_HAL_GPIO_0,
 ...
 *	}
 *
 *	static int _mtk_os_hal_pwm_release_gpio(int group_num,
 *		u32 channel_bit_map)
 *	{
 *		int ret = 0;
 *
