...
*    @code
*	//First call this function to initialize UART_PORT0 HW
*	mtk_os_hal_uart_ctlr_init(UART_PORT0);
*
*	u8 ch;
*
*	//Set UART_PORT0 baudrate to 115200
*	mtk_os_hal_uart_set_baudrate(UART_PORT0, 115200);
*
*	//Set UART_PORT0 data format
*	mtk_os_hal_uart_set_format(UART_PORT0, UART_DATA_8_BITS,
*		UART_NONE_PARITY, UART_STOP_1_BIT);
*
*	//Put char 'A' in PIO mode
*	mtk_os_hal_uart_put_char(UART_PORT0, 0x41);
*
*	//Get char in PIO mode
*	ch = mtk_os_hal_uart_get_char(UART_PORT0);
*
*    @endcode
*
